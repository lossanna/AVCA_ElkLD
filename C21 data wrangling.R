...
raw.c21.01_07.5 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                            sheet = "1 + 7.5 BAF")
raw.c21.01_49 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "1 + 49 ORD")
raw.c21.02_15 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "CHECK 2+15BAF")
raw.c21.03_80 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "3 + 80 BAF")
raw.c21.04_90 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "4 + 90 ORD")
raw.c21.06_36 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "6 + 36 BAF")
raw.c21.07_49.5 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "7 + 49.5 ORD")
raw.c21.07_66 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "7 + 66 BAF")
raw.c21.08_62 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "8 + 62 BAF")
raw.c21.09_99 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "9 + 99 ORD")
raw.c21.10_13 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "10 + 13 BAF")
raw.c21.11_12 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                            sheet = "11 + 12 ORD")
raw.c21.11_24 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                            sheet = "11 + 24 BAF")
raw.c21.11_63 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "11 + 63 ORD")
raw.c21.11_73 <- read_xlsx("AVCA ElkLD Channel 21 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "11 + 73 BAF")
...
save(all.c21,
     file = "C21 long all stations.RData")


save.image("C21 data wrangling.RData")
