...
raw.c19.01_04 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                             sheet = "1 + 04")
raw.c19.02_04 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "2 + 04")
raw.c19.02_52 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "2 +52")
raw.c19.03_63 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "3 + 63")
raw.c19.03_98 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "3 + 98")
raw.c19.05_00 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "5 + 00")
raw.c19.05_09 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                             sheet = "5 + 09")
raw.c19.05_62 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "5 + 62")
raw.c19.06_13 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "6 + 13")
raw.c19.06_97 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "6 + 97")
raw.c19.07_30 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "7 + 30")
raw.c19.07_50 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "7 + 50")
raw.c19.07_97 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "7 + 97")
raw.c19.09_05 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "9 + 05")
raw.c19.09_26 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "9 +26")
raw.c19.09_68 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "9 + 68")
raw.c19.10_98 <- read_xlsx("AVCA ElkLD Channel 19 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "10 + 80")
...
save(all.c19,
     file = "C19 long all stations.RData")


save.image("C19 data wrangling.RData")
