...
total.all.raw <- read.csv("data/cleaned/old-summarised/Summarised-all_total-plant-cover.csv")
per.div.raw <- read.csv("data/cleaned/old-summarised/Summarised-all_perennial-diversity.csv")
herb.all.raw <- read.csv("data/cleaned/old-summarised/Summarised-all_woody-herb-cover.csv")
...
save.image("RData/old_pre-2023-03-24/CV.RData")
