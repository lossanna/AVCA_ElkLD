...
load("Perennial diversity by year and channel.RData")
...
tiff("SRM 2022/Total plant cover.tiff", units = "in", height = 5.5, width = 10, res = 300)
total.plot.srm22
dev.off()
...
tiff("SRM 2022/Herbaceous cover.tiff", units = "in", height = 5.5, width = 10, res = 300)
herb.plot.srm22
dev.off()
...
tiff("SRM 2022/Inwood cover.tiff", units = "in", height = 7, width = 10, res = 300)
inwood.known.plot.srm22
dev.off()
...
tiff("SRM 2022/Richess.tiff", units = "in", height = 5.5, width = 10, res = 300)
richness.plot.srm22
dev.off()
...
tiff("SRM 2022/Shannon.tiff", units = "in", height = 5.5, width = 10, res = 300)
shannon.plot.srm22
dev.off()
...
tiff("SRM 2022/Soil cover.tiff", units = "in", height = 5.5, width = 10, res = 300)
ground.soil.plot.srm22
dev.off()
