...
# Load RData 
load("C:/Users/liaos/OneDrive - University of Arizona/grad school/Gornish lab/02_AVCA Elkhorn-Las Delicias/AVCA_ElkLD/amplicon-sequencing/FASTQ_16S_raw/16S_demultiplexing/16S_dada2_HPC_small.RData")
path <- "C:/Users/liaos/OneDrive - University of Arizona/grad school/Gornish lab/02_AVCA Elkhorn-Las Delicias/AVCA_ElkLD/amplicon-sequencing/FASTQ_16S_raw/16S_demultiplexing" 
```
...
```{r, eval=FALSE}
# Set working directory
setwd("/groups/egornish/lossanna/AVCA-ElkLD_16S/raw_data/16S_demultiplexing/")
```
...
```{r, eval=FALSE}
# Define working folder path 
path <- "/groups/egornish/lossanna/AVCA-ElkLD_16S/raw_data/16S_demultiplexing/" 
```
...
- The first 6 samples listed here have ~90% of the reads retained, which is to be expected.
