...
Appendices for "Dryland rock detention structures increase herbaceous vegetation cover and stabilize shrub cover over 10 years but do not directly affect soil fertility" by Ossanna et al. (2023). Included are code and analysis used to make figures and full model output. Data can be downloaded from the Zenodo archive under the DOI 10.5281/zenodo.8310363.
