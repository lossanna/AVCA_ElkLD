...
<<<<<<< Updated upstream
tiff("Fig2_temporal_notree-herb-shrub.tiff", units = "in", height = 8, width = 6, res = 1000)
...
tiff("FigS4_temporal_richness-Shannon.tiff", units = "in", height = 5.5, width = 6, res = 300)
...
tiff("Fig3_CV_shrub-herb-notree.tiff", units = "in", height = 4, width = 7, res = 1000)
...
# Supplemental figure
tiff("FigS5_CV_rich-shan.tiff", units = "in", height = 4, width = 5.5, res = 300)
...
tiff("Fig4_Soil-NMDS.tiff", height = 4, width = 7, units = "in", res = 1000)
...
# TN, TC, OM
tiff("FigS6_Soil-chem.tiff", units = "in", height = 4, width = 7, res = 300)
...
tiff("FigS7_Soil-richness.tiff", units = "in", height = 4, width = 5.5, res = 300)
...
tiff("FigS8_Soil-functional.tiff", units = "in", height = 4, width = 7, res = 300)
