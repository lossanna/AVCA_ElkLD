...
barcode <- read.table("amplicon-sequencing/demultiplexing/16S_barcodes.txt", header = TRUE) # change to your file name
...
write.txt(barcode_revcomp, 
          "amplicon-sequencing/demultiplexing/16S_barcodes_rev.txt", 
          sep = "\t", 
          quote = FALSE, 
          row.names = FALSE)
...
# Read in a CSV with the barcodes in the first column 
  # and the corresponding sample names in the second column
barcode <- read.csv("amplicon-sequencing/demultiplexing/ITS_barcodes.csv", header = TRUE) # change to your file name
...
write.csv(barcode_revcomp, 
            "amplicon-sequencing/demultiplexing/ITS_barcodes_rev.csv",
          row.names = FALSE)
```
