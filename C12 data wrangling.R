...
raw.c12.1_04 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "1 + 4")
raw.c12.1_52 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "1 + 52")
raw.c12.1_83 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "1 + 83")
raw.c12.2_63 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "2 + 63")
raw.c12.2_98 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "2 + 98")
raw.c12.3_93 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "3 + 93")
raw.c12.4_00 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "4 + 00")
raw.c12.4_09 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                          sheet = "4 + 09")
raw.c12.4_56 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "4 + 56")
raw.c12.4_65 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "4 + 65")
raw.c12.5_13 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "5 +13")
raw.c12.5_48 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "5 + 48")
raw.c12.6_30 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "6 + 30")
raw.c12.6_93 <- read_xlsx("AVCA ElkLD Channel 12 Data - USE FOR 2021 ANALYSIS_LO 220201.xlsx",
                           sheet = "6 + 97")
...
save(all.c12,
     file = "C12 long all stations.RData")


save.image("C12 data wrangling.RData")
